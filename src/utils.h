...
std::string graphviz_filename(const std::string&, tm *);

template <typename T>
std::ostringstream& join_helper(std::ostringstream& os, const std::string&, T v)
{
    os << v;
    return os;
}
...
std::ostringstream& join_helper(std::ostringstream& os, const std::string& sep, T v, Types... values)
{
    os << v << sep;
...
std::string join(const std::string& sep, Types... values)
{
