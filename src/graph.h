...
struct Graph
{
    ...
    inline std::map<uint32_t, std::unordered_set<uint32_t>>::iterator begin() { return graph.begin(); };
    inline std::map<uint32_t, std::unordered_set<uint32_t>>::iterator end() { return graph.end(); };
    inline std::map<uint32_t, std::unordered_set<uint32_t>>::const_iterator begin() const { return graph.begin(); };
    inline std::map<uint32_t, std::unordered_set<uint32_t>>::const_iterator end() const { return graph.end(); };
    inline std::map<uint32_t, std::unordered_set<uint32_t>>::size_type size() const { return graph.size(); };
protected:
