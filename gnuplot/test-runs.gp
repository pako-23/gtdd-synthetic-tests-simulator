...
set ylabel 'Test Runs (Thousands)'
...
do for [graph in graph_generators] {
  ...
  plot './results/experiments/pfast/'.graph.'/stats.dat' using 1:($8/1000):($7/1000):($11/1000):($10/1000) title texsc('Pfast') with candlesticks lc '#5252cc' lw 1.5 whiskerbars, \
       './results/experiments/pradet/'.graph.'/stats.dat' using 1:($8/1000):($7/1000):($11/1000):($10/1000) title texsc('PraDet') with candlesticks lc '#52cc52' lw 1.5 whiskerbars
}
