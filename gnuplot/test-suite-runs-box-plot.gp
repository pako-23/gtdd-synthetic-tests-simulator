...
set ylabel '# Schedule Runs (Log Scale)'
...
plot './results/experiments/pfast/fixed-probability/probability-0.0005/stats.csv' using (1):2 title texsc('Pfast') with boxplot  lc '#5252cc' lw 1.5, \
     ...
     './results/experiments/pradet/fixed-probability/probability-0.0005/stats.csv' using (0.7):2 title texsc('PraDet') with boxplot  lc '#52cc52' lw 1.5, \
     ...
     './results/experiments/mem-fast/fixed-probability/probability-0.0005/stats.csv' using (1.2):2 title texsc('Mem-Fast') with boxplot  lc '#cc5258' lw 1.5, \
